...
class ContextSeqEmbAbstractLayer(nn.Module):
    ...
    def embed_token_seq_fields(self, token_seq_fields, type, drop_first):
    ...
    def embed_input_fields(self, user_idx, item_idx, drop_first):
        ...
        for type in self.types:
            ...
            token_seq_fields_embedding[type] = self.embed_token_seq_fields(token_seq_fields, type, drop_first)
    ...
    def forward(self, user_idx, item_idx, drop_first=None):
        return self.embed_input_fields(user_idx, item_idx, drop_first)
